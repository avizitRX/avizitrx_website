...
const HeroSection = () => {
  return (
    <section id="hero_section">
      <div className="h-[80vh] md:h-[100vh] w-full dark:bg-black bg-white  dark:bg-grid-small-white/[0.2] bg-grid-small-black/[0.2] relative flex items-center justify-center">
