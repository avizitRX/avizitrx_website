...
export const HeroParallax = ({ posts }: { posts: Post[] }) => {
  ...
  return (
    <div
      ref={ref}
      className="h-[2150px] py-40 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
...
export const PostCard = ({
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src={post.image ?? "/Link_Share_Thumbnail.png"}
          height={600}
          width={600}
